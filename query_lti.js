...
$(document).ready(function () {
    $("a#prepare_course").click(function (ev) {
        $.ajax({
            url:"taskgenerator/prepare_course.php",
            type: "POST",
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            data: JSON.stringify(students_value()),
            error: function(obj, status) {
                alert("Error on saving prep course: " + status);
            },
...
//    $.ajax({
//        url:"taskgenerator/write.php",
//        type: "POST",
//        contentType: "application/json; charset=utf-8",
//        dataType: "json",
//        data: JSON.stringify(combine(test)),
//        error: function(obj, status) {
//            alert("Error on saving tasks:: " + status + obj);
//        },
//        success: function(data) {
//    	alert("Saved Tasks!");
//        }
...
//});
    ...
    $("a#salvar").click(function (ev) {
	var combined = combine(test);
        $.ajax({
            url:"trylogic-task-assignments/controllers/TaskAssignmentCreate.php",
            type: "POST",
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            data: JSON.stringify(combined),
            error: function(obj, status) {
                alert("Error registering tasks:: " + status + JSON.stringify(obj));
            },
            success: function(data) {
		$.ajax({
		    url:"taskgenerator/write.php",
		    ...
		    data: JSON.stringify(combined),
		    error: function(obj, status) {
			alert("Error on saving tasks:: " + status + JSON.stringify(obj));
		    },
		    success: function(data) {
			$.ajax({
			    url:"trylogic-task-assignments/controllers/TaskAssingmentSetStoreFlag.php",
			    type: "POST",
			    contentType: "application/json; charset=utf-8",
			    dataType: "json",
			    data: JSON.stringify(Object.assign({}, combined, {"flag_value":true})),
			    error: function(obj, status) {
				alert("Error on registering stored task flag :: " + status + JSON.stringify(obj));
			    },
			    success: function(data) {
				alert("Saved Tasks!");
			    }
    ...
    $("a#lcp_save").click(function (ev) {
        $.ajax({
            url:"taskgenerator/lcp_save.php",
            type: "POST",
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            data: JSON.stringify(students_value()),
            error: function(obj, status) {
                alert("Error on saving lcp: " + status);
            },
            success: function(data) {
                alert(data.msg);
            }
    ...
    $("a#lcpo_save").click(function (ev) {
        $.ajax({
            url:"taskgenerator/lcpo_save.php",
            type: "POST",
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            data: JSON.stringify(students_value()),
            error: function(obj, status) {
                alert("Error on saving lcpo: \n" + status + obj);
            },
            success: function(data) {
                alert(data.msg);
            }
    ...
    $("a#lcp_hidden").click(function (ev) {
        $.ajax({
            url:"taskgenerator/lcp_hidden.php",
            type: "POST",
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            data: JSON.stringify(students_value()),
    ...
    $("a#lcpo_hidden").click(function (ev) {
        $.ajax({
            url:"taskgenerator/lcpo_hidden.php",
            type: "POST",
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            data: JSON.stringify(students_value()),
    ...
    $("a#send").click(function (ev) {
        ...
        $.ajax({
            url:"taskgenerator/generate.php",
            type: "POST",
            contentType: "application/json; charset=utf-8",
            dataType: "json",
